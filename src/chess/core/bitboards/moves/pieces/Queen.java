...
public class Queen extends Piece {
	...
	public long wGetPossibleCaptures(long pieceBB, long bOcc, long empty) {
		return r.wGetPossibleCaptures(pieceBB, bOcc, empty) | b.wGetPossibleCaptures(pieceBB, bOcc, empty);
	}
	@Override
	public long bGetPossibleCaptures(long pieceBB, long wOcc, long empty) {
		return r.bGetPossibleCaptures(pieceBB, wOcc, empty) | b.bGetPossibleCaptures(pieceBB, wOcc, empty);
	}
	@Override
