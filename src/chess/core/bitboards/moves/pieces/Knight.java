...
public class Knight extends Piece {
  ...
  private long getAllPos(long pieceBB) { // Gets all L-Shaped moves
    return Moves.noNoEa(pieceBB) | Moves.noEaEa(pieceBB) | Moves.soEaEa(pieceBB)
        | Moves.soSoEa(pieceBB) | Moves.soSoWe(pieceBB) | Moves.soWeWe(pieceBB)
        | Moves.noWeWe(pieceBB) | Moves.noNoWe(pieceBB);
  }
